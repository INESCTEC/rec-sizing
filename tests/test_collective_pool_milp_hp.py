...
from rec_sizing.optimization.structures.I_O_collective_pool_milp_hp import (
	INPUTS_POOL_HP,
	OUTPUTS_POOL_HP
)
...
def test_solve_collective_pool_milp_hp():
	inputs = deepcopy(INPUTS_POOL_HP)
	...
	for ki, valu in results.items():
		assert valu == OUTPUTS_POOL_HP.get(ki), f'{ki}'

if __name__ == '__main__':
	test_solve_collective_pool_milp_hp()
