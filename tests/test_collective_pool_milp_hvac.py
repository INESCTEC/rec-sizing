...
from rec_sizing.optimization.structures.I_O_collective_pool_milp_hvac import (
	INPUTS_POOL_HVAC,
	OUTPUTS_POOL_HVAC
)
...
def test_solve_collective_pool_milp_hvac():
	inputs = deepcopy(INPUTS_POOL_HVAC)
	...
	for ki, valu in results.items():
		assert valu == OUTPUTS_POOL_HVAC.get(ki), f'{ki}'

if __name__ == '__main__':
	test_solve_collective_pool_milp_hvac()
